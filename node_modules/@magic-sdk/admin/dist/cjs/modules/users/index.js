...
var UsersModule = /** @class */ (function (_super) {
    ...
    UsersModule.prototype.getMetadataByIssuer = function (issuer) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getMetadataByIssuerAndWallet(issuer, types_1.WalletType.NONE)];
            });
        });
    };
    ...
    UsersModule.prototype.getMetadataByTokenAndWallet = function (DIDToken, walletType) {
        return __awaiter(this, void 0, void 0, function () {
            var issuer;
            return __generator(this, function (_a) {
                issuer = this.sdk.token.getIssuer(DIDToken);
                return [2 /*return*/, this.getMetadataByIssuerAndWallet(issuer, walletType)];
            });
        });
    };
    UsersModule.prototype.getMetadataByPublicAddressAndWallet = function (publicAddress, walletType) {
        return __awaiter(this, void 0, void 0, function () {
            var issuer;
            return __generator(this, function (_a) {
                issuer = issuer_1.generateIssuerFromPublicAddress(publicAddress);
    ...
    UsersModule.prototype.getMetadataByIssuerAndWallet = function (issuer, walletType) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        if (!this.sdk.secretApiKey)
                            throw sdk_exceptions_1.createApiKeyMissingError();
                        return [4 /*yield*/, rest_1.get(this.sdk.apiBaseUrl + "/v1/admin/auth/user/get", this.sdk.secretApiKey, { issuer: issuer, wallet_type: walletType })];
                    case 1:
                        data = _g.sent();
                        return [2 /*return*/, {
                                ...
                                wallets: (_f = data.wallets) !== null && _f !== void 0 ? _f : null,
                            }];
                }
            });
        });
